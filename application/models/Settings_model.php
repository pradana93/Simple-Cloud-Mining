...
class Settings_model extends MY_Model
{
    ...
    public function update()
	{
		$data = array(
			...
			'siteslogan' => $this->input->post('siteslogan', true),
			...
			'coin_email' => $this->input->post('coin_email', true),
			...
			'header_codes' => htmlspecialchars($this->input->post('header_codes', false)),
			'footer_codes' => htmlspecialchars($this->input->post('footer_codes', false)),
		);
