...
class Settings extends Admin_Controller
{
	...
	public function index()
	{
		...
		$this->form_validation->set_rules('siteslogan', 'Site Slogan', 'trim|required');
		...
		$this->form_validation->set_rules('coin_email', 'Invoice Email', 'trim|required');
		...
		$this->form_validation->set_rules('header_codes', 'Header Codes', 'trim');
		$this->form_validation->set_rules('footer_codes', 'Footer Codes', 'trim');
		...
		if ($this->form_validation->run() === TRUE) {
			...
			if ($this->settings_model->update()) {
				...
				//Delete blockchain url cache
				$this->cache->delete('blockchainUrl');
