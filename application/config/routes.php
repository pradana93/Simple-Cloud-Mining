...
$route[$adminPrefix.'/clearcache'] = 'admin/Settings/clearCache';
...
$route[$adminPrefix.'/withdrawals-history'] = 'admin/Withdrawals/paid';
$route[$adminPrefix.'/withdrawals-history/(:num)'] = 'admin/Withdrawals/paid/$1';
$route[$adminPrefix.'/withdrawals-history/view/(:num)'] = 'admin/Withdrawals/view/$1';
...
$route[$adminPrefix.'/error_logs'] = 'admin/Ipnlogs/showLogs';
$route[$adminPrefix.'/error_logs_list'] = 'admin/Ipnlogs/showLogsList';
...
$route[$adminPrefix.'/update'] = 'admin/Update/index';
$route[$adminPrefix.'/check_update'] = 'admin/Update/check';

$route[$adminPrefix.'/contents'] = 'admin/Contents/index';

$route[$adminPrefix.'/faqs'] = 'admin/Faqs/index';
$route[$adminPrefix.'/faqs/(:num)'] = 'admin/Faqs/index/$1';
$route[$adminPrefix.'/faqs/create'] = 'admin/Faqs/create';
$route[$adminPrefix.'/faqs/edit/(:num)'] = 'admin/Faqs/edit/$1';
$route[$adminPrefix.'/faqs/delete/(:num)'] = 'admin/Faqs/delete/$1';
