...
<div class="card-body">
	...
	<form action="<?php echo installRoute('install/step4');?>" method="post" id="formStep">
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="form-group">
					...
					<small class="form-text">Eg.: https://www.yoursite.com/. With / at end</small>
				</div>
			</div>
			<div class="col-md-6">
				<div class="form-group">
		...
		<div class="row">
			<div class="col-md-4">
				<div class="form-group">
					<label>Mail Host (Outgoing)</label>
		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					...
					<small class="help-block text-muted">Click <a href="https://www.coinpayments.net/acct-settings" target="_blank">here</a>. Can be found on 'Basic Settings' tab.</small>
				</div>
			</div>
			<div class="col-md-6">
				<div class="form-group">
					...
					<small class="help-block text-muted">Click <a href="https://www.coinpayments.net/acct-settings" target="_blank">here</a>. Set this on 'Merchant Settings' tab, IPN Secret Key.</small>
				</div>
			</div>
			<div class="col-md-12">
			...
			<div class="col-md-6">
				<div class="form-group">
					...
					<small class="help-block text-muted">Click <a href="https://www.coinpayments.net/acct-api-keys" target="_blank">here</a> to get your key</small>
				</div>
			</div>
			<div class="col-md-6">
				<div class="form-group">
