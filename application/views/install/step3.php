		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="form-group">
					...
					<input type="text" name="db_host" class="form-control" placeholder="Your Database Host" value="<?php echo set_value('db_host', 'localhost'); ?>">
			...
			<div class="col-md-4">
				<div class="form-group">
					...
					<input type="number" name="db_port" class="form-control" placeholder="Your Database Port" value="<?php echo set_value('db_port', 3306); ?>">
