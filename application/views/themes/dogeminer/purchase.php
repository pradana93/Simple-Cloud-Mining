			...
			<div class="col-sm-6 col-sm-offset-3">
				<div class="panel panel-info">
					...
					<div class="panel-body">
						<p class="list-group-item"><b>Purchase Price:</b> <?php echo $invoice['amount']; ?> <?php echo settings('currency_code');?></p>
						<p class="list-group-item"><b>Payment Address:</b>
							...
							<span class="help-block text-muted">* Click to select all</span>
						</p>
