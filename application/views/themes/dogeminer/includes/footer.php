<div class="footer">
	<div class="container">
		© <?php echo settings('sitename'); ?> <?php echo date('Y');?>. All rights reserved.
	</div>
</div>
...
<script type="text/javascript">
	...
	<?php endif; ?>
	<?php if(current_url()===base_url('withdrawal')): ?>
	function requestWithdrawal() {
		this.event.preventDefault();
		let button = document.getElementById('withdrawalNow');
		button.innerHTML = '<i class="fa fa-spinner fa-spin"></i> Processing, please wait...';
		button.disabled = true;
		this.event.currentTarget.submit();
	}
	<?php endif; ?>
</script>
<?php echo htmlspecialchars_decode(settings('footer_codes')); ?>
</body>
</html>
