...
<head>
	<meta charset="utf-8">
	<title><?php echo settings('sitename'); ?> - <?php echo settings('siteslogan'); ?></title>
	...
	<link rel="stylesheet" href="<?php echo themeAssets('css/style.min.css'); ?>">
	<?php echo htmlspecialchars_decode(settings('header_codes')); ?>
</head>
<body>
...
<a href="<?php echo base_url(); ?>" class="logo-block" title="<?php echo settings('sitename'); ?>">
