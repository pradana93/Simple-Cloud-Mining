							...
							<div class="row">
								<div class="col-lg-6 col-sm-12">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="plan_name" id="plan_name" placeholder="Plan name" value="<?php echo $item['plan_name']; ?>" required>
									</div>
								</div>
								<div class="col-lg-6 col-sm-12">
							...
							<div class="row">
								<div class="col-lg-4 col-sm-12">
									<div class="form-group">
										...
										<div class="input-group">
											<input type="text" id="plan_price" class="form-control" name="price" placeholder="Plan Price" value="<?php echo $item['price']; ?>" onkeyup="return calculateProfit()" required>
								...
								<div class="col-lg-4 col-sm-12">
									<div class="form-group">
										...
										<div class="input-group">
											<input type="number" min="0" id="duration" class="form-control" name="duration" placeholder="Plan duration (days)" value="<?php echo $item['duration']; ?>" onkeyup="return calculateProfit()" required>
											<div class="input-group-append">
								...
								<div class="col-lg-4 col-sm-12">
									<div class="form-group">
										...
										<div class="input-group">
											...
											<input type="text" id="earning_rate" class="form-control" name="earning_rate" placeholder="Coins per minute" value="<?php echo $item['earning_rate']; ?>" onkeyup="return calculateProfit()" required>
											<div class="input-group-append">
