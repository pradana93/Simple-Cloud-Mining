					...
					<div class="card-body">
						<form action="<?php adminRoute('urlchains/add'); ?>" method="POST">
							...
							<div class="form-group">
								...
								<small class="help-block text-muted">Eg: https://dogechain.info/tx/. In your site will be: https://dogechain.info/tx/YourPaymentTansactionId. Search Google/Bing/Yahoo for: CURRENCY_NAME_HERE explorer. Eg: TRX explorer</small>
							</div>
