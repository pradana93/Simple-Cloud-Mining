...
<div class="breadcrumb-holder">
	<div class="container-fluid">
		<ul class="breadcrumb">
			...
			<li class="breadcrumb-item active">Edit F.A.Q.</li>
		</ul>
	</div>
</div>
<!-- /. ROW  -->
<section>
	<div class="container-fluid">
		<header>
			...
			<h1 class="h3 display">Edit F.A.Q.</h1>
		</header>
		...
		<div class="row">
			<div class="col-sm-12 col-lg-12">
				<div class="card">
					<div class="card-body">
						<form action="<?php adminRoute('faqs/edit'); ?>" method="POST">
							<div class="form-group">
								<label for="question">Question</label>
								<input type="text" class="form-control" name="question" id="question" placeholder="Question" value="<?php echo $item['question']; ?>" required>
							</div>
							<div class="form-group">
								<label for="answer">Answer</label>
								<textarea name="answer" id="answer" class="form-control" rows="10" placeholder="Answer"
										  required><?php echo $item['answer']; ?></textarea>
							</div>
