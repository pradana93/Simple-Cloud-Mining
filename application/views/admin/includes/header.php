	...
	<div class="side-navbar-wrapper">
		...
		<div class="main-menu">
			...
			<ul id="side-main-menu" class="side-menu list-unstyled">
				...
				<li class="<?php echo $activeUrl==='withdrawals-history'?'active':'';?>">
					<a href="<?php echo adminRoute('withdrawals-history');?>"><i class="fa fa-line-chart"></i>Withdrawal History</a>
				</li>
		...
		<div class="admin-menu">
			<h5 class="sidenav-heading">Content</h5>
			<ul id="side-admin-menu" class="side-menu list-unstyled">
				<li class="<?php echo $activeUrl==='contents'?'active':'';?>">
					<a href="<?php echo adminRoute('contents');?>"><i class="fa fa-font"></i>Page Contents</a>
				</li>
				<li class="<?php echo $activeUrl==='faqs'?'active':'';?>">
					<a href="<?php echo adminRoute('faqs');?>"><i class="fa fa-question-circle"></i>F.A.Q.s</a>
				</li>
		...
		<div class="admin-menu">
			...
			<ul id="side-admin-menu" class="side-menu list-unstyled">
				...
				<li class="<?php echo $activeUrl==='update'?'active':'';?>">
					<a href="<?php echo adminRoute('update');?>"><i class="fa fa-refresh"></i>Update Script</a>
				</li>
			</ul>
		</div>
		<div class="admin-menu">
			<h5 class="sidenav-heading">Errors & Logs</h5>
			<ul id="side-admin-menu" class="side-menu list-unstyled">
				...
				<li class="<?php echo $activeUrl==='error_logs'?'active':'';?>">
					<a href="<?php echo adminRoute('error_logs');?>"><i class="fa fa-exclamation-triangle"></i>Log Viewer</a>
				</li>
			</ul>
		</div>
		<div class="admin-menu">
